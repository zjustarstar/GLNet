...
from utils.engine import evaluation_none_training, evaluation_none_training_ori
...
def main():
    ...
    flag = 1
    train_set, test_set, ignore_index = get_data(args, flag)
    ...
    val_loader = DataLoader(test_set, batch_size=args.batch_size, sampler=sampler_val, num_workers=args.num_workers,
                            shuffle=False)
    evaluation_none_training_ori(args, model, val_loader, device)
