...
def get_args_parser():
    ...
    # train settings
    parser.add_argument("--dataset", type=str, default="facade")  # 数据集（一般填facade，cmp数据集填cmp）
    parser.add_argument("--model_name", type=str, default="Segmenter")  # Segmenter or PSPNet
    parser.add_argument("--pre_model", type=str, default="ViT-B_16.npz")  # 预训练的权重
    parser.add_argument("--batch_size", type=int, default=4,
                        help="Number of images sent to the network in one step.")
    parser.add_argument("--root", type=str, default="E:/Experiments/RTFP-improve/data/",
                        help="Path to the directory containing the image list.")
    # 768*768(cmp) 2048*2048(hznu) 1024*2048(cfp和ERTIMS)
    # parser.add_argument("--setting_size", type=int, default=[768, 768],
    ...
    # optimizer settings
    parser.add_argument("--lr", type=float, default=0.0001, help="Base learning rate for training with polynomial "
                                                                 "decay.")  # 0.0001
    ...
    parser.add_argument('--output_dir', default='E:/Experiments/RTFP-improve/models/', help='path where to save, empty for no '
                                                                                'saving')
