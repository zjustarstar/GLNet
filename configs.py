...
def get_args_parser():
    ...
    parser.add_argument("--model_name", type=str, default="Segmenter")#Segmenter#PSPNet
    parser.add_argument("--pre_model", type=str, default="ViT-B_16.npz")
    parser.add_argument("--batch_size", type=int, default=4,
                        help="Number of images sent to the network in one step.")
    parser.add_argument("--root", type=str, default="D:/project/RTFP-improve/data/",
                        help="Path to the directory containing the image list.")
    parser.add_argument("--setting_size", type=int, default=[2048, 2048],#768*768(cmp)#1067*800(ruemonge)#hznu()
    ...
    # optimizer settings
    parser.add_argument("--lr", type=float, default=0.0001, help="Base learning rate for training with polynomial decay.")#0.0001
    ...
    parser.add_argument('--output_dir', default='D:/project/RTFP-improve/models/', help='path where to save, empty for no saving')
