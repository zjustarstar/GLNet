...
from data import RueMonge
from data import cmp
def get_data(args, evaluation_setting=None):
    ...
    if args.dataset == "cityscapes":
        ...
        train_set = RueMonge.Facade(args, 'train', joint_transform=joint_transformations,
                                              standard_transform=standard_transformations)
        ...
        val_set = RueMonge.Facade(args, current_set, joint_transform=joint_transformations_val,
                                            standard_transform=standard_transformations)
        ignore_index = RueMonge.ignore_label
        args.num_classes = RueMonge.num_classes
    elif args.dataset == "cmp":
        train_set = cmp.Facade(args, 'train', joint_transform=joint_transformations,
                                              standard_transform=standard_transformations)
        ...
        val_set = cmp.Facade(args, current_set, joint_transform=joint_transformations_val,
                                            standard_transform=standard_transformations)
        ignore_index = cmp.ignore_label
        args.num_classes = cmp.num_classes
    else:
