...
def angle_filter(lines, percentage=50):
    ...
    filtered_lines = [line for line in lines if calculate_line_angle(line[0], line[1], line[2], line[3]) in angles_to_keep]
...
def main():
    ...
    output_folder1 = "./Test/example_point/lines_same"
    output_folder2 = "./Test/example_point/lines_diff"
    output_folder4 = "./Test/example_point/lines_class"
    output_folder5 = "./Test/example_point/len_filter1"
    output_folder6 = "./Test/example_point/lines_fit"
    output_folder8 = "./Test/example_point/regions"
    output_folder9 = "./Test/example_point/ang_filter1+fit_regions"
    output_folder10 = "./Test/example_point/len_filter2"
    output_folder11 = "./Test/example_point/ang_filter2"
    output_folder12 = "./Test/example_point/bl"
    output_folder13 = "./Test/example_point/four_pts"
    output_folder14 = "./Test/example_point/point"
