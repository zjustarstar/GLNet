...
# 调用主函数，传入图像路径和XML路径
image_path = r'./origin/20250118100841.png'  # 修改为你的图像路径
image_path_col = r'./ori/IMG_4371.HEIC.jpg'  # 修改为你的彩色图像路径
xml_path = r'./position/IMG_4371-HEIC_JPG.rf.f8cc5c916e05355a573680ddf4cbe2e8.xml'  # 修改为你的XML路径
