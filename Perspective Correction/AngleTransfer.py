...
# image_folder = r'D:\wf-Facade\GLNet\Perspective Correction\angle_adjust_train_ori'
# output_folder = r'D:\wf-Facade\GLNet\Perspective Correction\result'
image_folder = r'./test/Construction/origin'
output_folder = r'./test/Construction/results'
# matrix_folder = r'D:\wf-Facade\GLNet\Perspective Correction\test\example_point\transfer\matrices-algorithmic'
# points_folder = r'D:\wf-Facade\GLNet\Perspective Correction\test\example_point\transfer\points-algorithmic'
# matrix_folder = r'E:\Experiments\GLNet\Perspective Correction\test\example_point\transfer\matrices-manual'
# points_folder = r'E:\Experiments\GLNet\Perspective Correction\test\example_point\transfer\points-manual'
matrix_folder = r'./test/Construction/example_point/matrices'
points_folder = r'./test/Construction/example_point/point'
...
for filename in sorted(os.listdir(image_folder)):
    ...
    if filename:  # 仅当文件名非空时
        ...
        # points_file_path = os.path.join(points_folder, f"{base_filename}_point.txt")
